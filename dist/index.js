...
var _newArrowCheck2 = __webpack_require__(20);
...
var logger = __webpack_require__(14).get('VueRestResource:http');
...
var logger = __webpack_require__(14).get('VueRestResource:moduleName');
...
var _v = __webpack_require__(108);
...
var _rest = __webpack_require__(136);

var _rest2 = _interopRequireDefault(_rest);

var _requestsStore = __webpack_require__(159);

var _requestsStore2 = _interopRequireDefault(_requestsStore);

var _moduleName = __webpack_require__(77);

var _moduleName2 = _interopRequireDefault(_moduleName);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var logger = __webpack_require__(14).get('VueRestResource');
...
var rng = __webpack_require__(109);
var bytesToUuid = __webpack_require__(110);
...
var _http2 = __webpack_require__(60);

var _http3 = _interopRequireDefault(_http2);

var _subscriber = __webpack_require__(158);
...
var logger = __webpack_require__(14).get('VueRestResource:rest');
...
var Rest = function (_http) {
  ...
  function Rest(uuid, resources, config) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Rest.__proto__ || (0, _getPrototypeOf2.default)(Rest)).call(this, resources, config));
  ...
  (0, _createClass3.default)(Rest, [{
    ...
    value: function dispatch(action, _ref) {
      ...
      ajax.then(function (res) {
        ...
        var responseCopy = JSON.parse((0, _stringify2.default)(res)); //
    ...
    value: function handleQueue(request, action, endpoint) {
      ...
      if (request.params && (0, _keys2.default)(request.params).length > 1) {
        return _axios2.default[action].apply(_axios2.default, [endpoint].concat(args));
      }
      ...
      var defered = new _promise2.default(function (resolve, reject) {
...
var logger = __webpack_require__(14).get('VueRestResource:subscriber');
...
var _extends4 = __webpack_require__(40);

var _extends5 = _interopRequireDefault(_extends4);

var _noop = __webpack_require__(161);

var _noop2 = _interopRequireDefault(_noop);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var logger = __webpack_require__(14).get('VueRestResource:requestsStore');

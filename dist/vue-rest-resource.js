...
var _class = function () {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function dispatch(action, _ref) {
      ...
      var ajax = _axios2.default[actionType].apply(_axios2.default, [endpoint].concat(args));
...
var _extends5 = __webpack_require__(16);
...
var getStoreResourceValue = function (instance, asyncID, asyncKey, resource) {
  (0, _newArrowCheck3.default)(undefined, undefined);
  ...
  var state = instance.$store.getters[String(apiModule) + '/' + String(apiModel)] || [];

  if (Array.isArray(state)) {
    return state.find(function (obj) {
      (0, _newArrowCheck3.default)(undefined, undefined);
      return obj[asyncKey] === asyncID;
    }.bind(undefined)) || noValueFound;
  }
...
var getResourceValue = function (instance, RestResources, AsyncValueResolvers, relatedAsyncID, asyncKeys) {
  (0, _newArrowCheck3.default)(undefined, undefined);
...
var _methods2 = __webpack_require__(53);

var _methods3 = _interopRequireDefault(_methods2);

var _subscriber = __webpack_require__(74);

var _subscriber2 = _interopRequireDefault(_subscriber);

var _moduleName = __webpack_require__(42);
...
var Rest = function (_methods) {
  ...
  (0, _createClass3.default)(Rest, [{
    ...
    value: function dispatch(action, _ref) {
      ...
      var request = this.register.apply(this, [actionType, { apiModel: apiModel, apiModule: apiModule, endpoint: endpoint }].concat(args));
    ...
    value: function register(action, moduleInfo) {
      ...
      return (0, _extends3.default)({}, moduleInfo, {
        action: action,
        created: Date.now(),
        id: id,
        params: params,
...
var _v = __webpack_require__(107);

var _v2 = _interopRequireDefault(_v);

var _methods = __webpack_require__(53);
...
var _requestsStore = __webpack_require__(65);
...
exports.default = function (config) {
  ...
  return (0, _extends3.default)({}, _helpers2.default, {
